...
export declare type TransactionOrTransactionHash =
  | Transaction
  | TransactionHash;
/**
 *
...
export declare type EthGetBalance = (
  address: Address,
  blockNumber: BlockNumber
) => Promise<IntegerOrNull>;
export declare type EthGetBlockByHash = (
  blockHash: BlockHash,
  includeTransactions: IsTransactionsIncluded
) => Promise<BlockOrNull>;
export declare type EthGetBlockByNumber = (
  blockNumber: BlockNumberOrTag,
  includeTransactions: IsTransactionsIncluded
) => Promise<BlockOrNull>;
export declare type EthGetBlockTransactionCountByHash = (
  blockHash: BlockHash
) => Promise<IntegerOrNull>;
export declare type EthGetBlockTransactionCountByNumber = (
  blockNumber: BlockNumberOrTag
) => Promise<IntegerOrNull>;
export declare type EthGetCode = (
  address: Address,
  blockNumber: BlockNumber
) => Promise<Bytes>;
export declare type EthGetFilterChanges = (
  filterId: FilterId
) => Promise<LogResult>;
export declare type EthGetFilterLogs = (
  filterId: FilterId
) => Promise<SetOfLogs>;
export declare type EthGetRawTransactionByHash = (
  transactionHash: TransactionHash
) => Promise<Bytes>;
export declare type EthGetRawTransactionByBlockHashAndIndex = (
  blockHash: BlockHash,
  index: Integer
) => Promise<Bytes>;
export declare type EthGetRawTransactionByBlockNumberAndIndex = (
  blockNumber: BlockNumberOrTag,
  index: Integer
) => Promise<Bytes>;
export declare type EthGetLogs = (filter: Filter) => Promise<SetOfLogs>;
export declare type EthGetStorageAt = (
  address: Address,
  key: Position,
  blockNumber: BlockNumberOrTag
) => Promise<DataWord>;
export declare type EthGetTransactionByBlockHashAndIndex = (
  blockHash: BlockHash,
  index: Integer
) => Promise<TransactionOrNull>;
export declare type EthGetTransactionByBlockNumberAndIndex = (
  blockNumber: BlockNumberOrTag,
  index: Integer
) => Promise<TransactionOrNull>;
export declare type EthGetTransactionByHash = (
  transactionHash: TransactionHash
) => Promise<TransactionOrNull>;
export declare type EthGetTransactionCount = (
  address: Address,
  blockNumber: BlockNumberOrTag
) => Promise<NonceOrNull>;
export declare type EthGetTransactionReceipt = (
  transactionHash: TransactionHash
) => Promise<TransactionReceiptOrNull>;
export declare type EthGetUncleByBlockHashAndIndex = (
  blockHash: BlockHash,
  index: Integer
) => Promise<BlockOrNull>;
export declare type EthGetUncleByBlockNumberAndIndex = (
  uncleBlockNumber: BlockNumber,
  index: Integer
) => Promise<BlockOrNull>;
export declare type EthGetUncleCountByBlockHash = (
  blockHash: BlockHash
) => Promise<IntegerOrNull>;
export declare type EthGetUncleCountByBlockNumber = (
  blockNumber: BlockNumberOrTag
) => Promise<IntegerOrNull>;
export declare type EthGetProof = (
  address: Address,
...
export declare type EthSendRawTransaction = (
  signedTransactionData: Bytes
) => Promise<Keccak>;
export declare type EthSubmitHashrate = (
  hashRate: DataWord,
  id: DataWord
) => Promise<BooleanVyG3AETh>;
export declare type EthSubmitWork = (
  nonce: Nonce,
  powHash: PowHash,
  mixHash: MixHash
) => Promise<BooleanVyG3AETh>;
export declare type EthSyncing = () => Promise<IsSyncingResult>;
export declare type EthUninstallFilter = (
  filterId: FilterId
) => Promise<BooleanVyG3AETh>;
